...
![Untitled](https://kricsleo.com/img/Untitled.png)
...
![Untitled](https://kricsleo.com/img/Untitled4.png)

2. 服务端（支持TLS1.3）响应`Server Hello`包，在`supported_versions`中根据客户端和自己的支持情况选择了TLS1.3

![Untitled](https://kricsleo.com/img/Untitled5.png)
...
![Untitled](https://kricsleo.com/img/Untitled6.png)

1. 然后服务端的`Server Hello`中`application_layer_protocol_negotiation`根据客户端以及自己的支持情况选择了高版本的`h2`

![Untitled](https://kricsleo.com/img/Untitled7.png)
...
![Untitled](https://kricsleo.com/img/Untitled8.png)
...
![image-20220714100424892](https://kricsleo.com/img/image-20220714100424892.png)

- 浏览器控制台->Security面板->Connection查看TLS版本信息

![image-20220714100604813](https://kricsleo.com/img/image-20220714100604813.png)

![image-20220714100528491](https://kricsleo.com/img/image-20220714100528491.png)
