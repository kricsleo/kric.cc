...
示例:
![](https://kricsleo.com/img/20220114175608.png)
...
- `Access-Control-Allow-Origin`: 表示有哪些域可以发送跨域的请求到本站, 配置方式有两种, 一种是通配符`*`, 表示可以接受任何域的请求, 另一种是固定的一个域名: 例如`https://kricsleo.com`, 注意这种方式只能填写一个域名, 不能配置多个.
...
- SSL/TLS证书交换过程
![SSL/TLS证书交换过程](https://kricsleo.com/img/_SSL_TLS 证书交换过程.png)

## Content-Type

[关于Content-Type](https://kricsleo.com/blog/Content-Type/)
